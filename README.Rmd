...
A description of the results from the application section can be found here: 
https://github.com/giuseppec/featureImportance/blob/master/ecml-demo/application_results.md
