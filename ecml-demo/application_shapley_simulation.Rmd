...
plot.ex = plot.ex +
  ...
  theme_minimal() #+
  #theme(legend.key.size = unit(0.75, "line"), title = element_text(size = 8), axis.title = element_text(size = 8),  axis.text.y = element_text(size = 7))
